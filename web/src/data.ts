...
export const jobs: Job[] = [
    {
        ...
        command: 'python train.py --config /mnt/config/bimanual.yaml --enable-robot-channel',
        env: [{key: 'WANDB_PROJECT', value: 'bimanual-assembly'}, {key: 'RLARK_JOB_ID', value: 'rl-bimanual-042'}],
        mounts: [{
            objectStorage: 's3://rlark-datasets/bimanual',
            mountPath: '/mnt/dataset'
        }, {objectStorage: 's3://rlark-checkpoints/policy', mountPath: '/mnt/checkpoints'}],
        headerRole: 'Learner',
    ...
    },
    {
        ...
        duration: '1h 41m',
        progress: 57,
        defaultRoles: ['Collector', 'Robot Operator', 'Uploader', 'Quality Checker'],
