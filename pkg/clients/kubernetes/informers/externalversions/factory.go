...
import (
	...
	rlarkio "github.com/rlinf/rlark/pkg/clients/kubernetes/informers/externalversions/rlark.io"
...
type SharedInformerFactory interface {
	...
	Rlinf() rlarkio.Interface
}

func (f *sharedInformerFactory) Rlinf() rlarkio.Interface {
	return rlarkio.New(f, f.namespace, f.tweakListOptions)
}
