...
type TaskInformer interface {
	...
	Lister() rlarkiov1alpha1.TaskLister
}
...
func NewTaskInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
	gvr := schema.GroupVersionResource{Group: "rlinf.io", Version: "v1alpha1", Resource: "tasks"}
	...
	return cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				...
				return client.RlinfV1alpha1().Tasks(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.RlinfV1alpha1().Tasks(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.RlinfV1alpha1().Tasks(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.RlinfV1alpha1().Tasks(namespace).Watch(ctx, opts)
			},
		}, client),
		&apisrlarkiov1alpha1.Task{},
...
func (f *taskInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisrlarkiov1alpha1.Task{}, f.defaultInformer)
}

func (f *taskInformer) Lister() rlarkiov1alpha1.TaskLister {
	return rlarkiov1alpha1.NewTaskLister(f.Informer().GetIndexer())
}
