...
type PodInformer interface {
	...
	Lister() rlarkiov1alpha1.PodLister
}
...
func NewPodInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
	gvr := schema.GroupVersionResource{Group: "rlinf.io", Version: "v1alpha1", Resource: "pods"}
	...
	return cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				...
				return client.RlinfV1alpha1().Pods(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.RlinfV1alpha1().Pods(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.RlinfV1alpha1().Pods(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.RlinfV1alpha1().Pods(namespace).Watch(ctx, opts)
			},
		}, client),
		&apisrlarkiov1alpha1.Pod{},
...
func (f *podInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisrlarkiov1alpha1.Pod{}, f.defaultInformer)
}

func (f *podInformer) Lister() rlarkiov1alpha1.PodLister {
	return rlarkiov1alpha1.NewPodLister(f.Informer().GetIndexer())
}
