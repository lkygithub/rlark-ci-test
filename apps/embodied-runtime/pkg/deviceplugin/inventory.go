...
// ros-controller and camera-controller via their Unix sockets and caches the
// results. The cached lists are exposed through Robots() / Cameras() for
// other components (e.g. Allocate) to inspect the node-local device
