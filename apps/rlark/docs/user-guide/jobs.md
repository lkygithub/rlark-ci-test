...
### Step 1: Select Job Type and Roles
...
### Step 4: YAML Preview and Submit

Before submitting, review the generated YAML manifest that represents your job. This YAML is a Kubernetes-compatible CRD (`Job.rlinf.io/v1alpha1`) that describes the full job specification.
