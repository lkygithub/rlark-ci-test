...
type AddonStatusApplyConfiguration struct {
	Phase      *rlarkiov1alpha1.AddonPhase      `json:"phase,omitempty"`
...
func (b *AddonStatusApplyConfiguration) WithPhase(value rlarkiov1alpha1.AddonPhase) *AddonStatusApplyConfiguration {
	b.Phase = &value
	return b
}
...
func (b *AddonStatusApplyConfiguration) WithMessage(value string) *AddonStatusApplyConfiguration {
	b.Message = &value
	return b
}
...
func (b *AddonStatusApplyConfiguration) WithConditions(values ...*v1.ConditionApplyConfiguration) *AddonStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
