...
type TaskLister interface {
	...
	List(selector labels.Selector) (ret []*rlarkiov1alpha1.Task, err error)
...
type taskLister struct {
	listers.ResourceIndexer[*rlarkiov1alpha1.Task]
}

// NewTaskLister returns a new TaskLister.
func NewTaskLister(indexer cache.Indexer) TaskLister {
	return &taskLister{listers.New[*rlarkiov1alpha1.Task](indexer, rlarkiov1alpha1.Resource("task"))}
}

// Tasks returns an object that can list and get Tasks.
func (s *taskLister) Tasks(namespace string) TaskNamespaceLister {
	return taskNamespaceLister{listers.NewNamespaced[*rlarkiov1alpha1.Task](s.ResourceIndexer, namespace)}
}
...
type TaskNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*rlarkiov1alpha1.Task, error)
