...
type PodLister interface {
	...
	List(selector labels.Selector) (ret []*rlarkiov1alpha1.Pod, err error)
...
type podLister struct {
	listers.ResourceIndexer[*rlarkiov1alpha1.Pod]
}

// NewPodLister returns a new PodLister.
func NewPodLister(indexer cache.Indexer) PodLister {
	return &podLister{listers.New[*rlarkiov1alpha1.Pod](indexer, rlarkiov1alpha1.Resource("pod"))}
}

// Pods returns an object that can list and get Pods.
func (s *podLister) Pods(namespace string) PodNamespaceLister {
	return podNamespaceLister{listers.NewNamespaced[*rlarkiov1alpha1.Pod](s.ResourceIndexer, namespace)}
}
...
type PodNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*rlarkiov1alpha1.Pod, error)
